...
- 🍎 Elaboré una clase sobre mapas con `R` para [The GRAPH Network](https://thegraphcourses.org/courses-portal/);
...
- 🏠 Soy un investigador con *orientación computacional* formado en **genética y biotecnología**, y aplicación estadística en **epidemiología**;
