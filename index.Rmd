...
![](figure/front-talk-purrr-4.PNG){ width=100% }
...
![](figure/front-talk-epiapli-4.PNG){ width=100% }
...
![](figure/front-workshop-ggplot-2.PNG){ width=100% }
...
![](figure/front-talk-biostat-2.PNG){ width=100% }
...
![](figure/front-workflow-microarrays.PNG){ width=100% }
...
- 💕 I intentionally used **cam** in reference to my [tusan](https://www.mychinaroots.com/surnames/detail?word=Campos) ancestry
