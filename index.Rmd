...
- 💻 Freelancer, remote teacher, doing a research internship; 
...
- ⭐ Coordinator in a last [outbreak analysis](https://mobile.twitter.com/cdc_peru/status/1392099144689401857) [course](https://www.dge.gob.pe/portalnuevo/informativo/prensa/curso-internacional-en-analisis-de-brotes-modelamiento-y-respuesta-en-salud-publica/) in [latinamerica](https://twitter.com/avallecam/status/1413682203041701889?s=20);
...
<center>
 `r knitr::asis_output("\U1F12F")` `r knitr::asis_output("\U229C")` `r knitr::asis_output("\U1F16D")` `r knitr::asis_output("\U1F16F")` `r knitr::asis_output("\U1F10E")` 
</center>
<center>
