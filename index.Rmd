...
![](figure/avallecam-profile-20211030.jpeg){ width=100% }
...
- ⭐ Coordinator in a last [outbreak analysis course](https://mobile.twitter.com/cdc_peru/status/1392099144689401857) in [latinamerica](https://twitter.com/avallecam/status/1413682203041701889?s=20);
...
- ⚙️ I am a proficient **`R` user**, expert data **wrangler** and **visualization** enthusiast. 
- ☁️ I am fluid with using `bash` for **automation** and `shh` **remote** computing.
...
library(tidyverse)
scholar::get_publications("p1Tq4esAAAAJ") %>% 
  as_tibble() %>% 
  knitr::kable()
```
...
![](figure/front-serosurvey.PNG){ width=100% }
...
![](figure/front-purrr.PNG){ width=100% }
...
![](figure/front-epiapli.PNG){ width=100% }
...
![](figure/front-lecture-spatial.PNG){ width=100% }
...
![](figure/front-workshop-outbreak.PNG){ width=100% }
...
![](figure/front-workshop-intror.PNG){ width=100% }
...
![](figure/front-workshop-ggplot.PNG){ width=100% }
...
![](figure/front-workshop-projects.PNG){ width=100% }
...
![](figure/front-workshop-biostats.PNG){ width=100% }
...
![](figure/front-workshop-reprosci.PNG){ width=100% }
