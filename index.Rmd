...
- 🎉 Community builder and Trainer at [the Epiverse-TRACE](https://data.org/initiatives/epiverse/);
- 🍎 Crafted a GeoViz with `R` lesson for [The GRAPH Network](https://thegraphcourses.org/courses-portal/);
...
- 🏠 I am a *computationally-oriented* researcher trained in **genetics and biotech**, and apply statistics in **epidemiology**;
